...
class App {
  ...
  middlewares() {
    ...
    this.app.use(_express2.default.static(_path.resolve.call(void 0, __dirname, '..', '..', 'images'))); // Permite acessar arquivos estáticos, neste caso os de dentro da pasta "uploads"
  }
