...
class TextController {
  ...
  async index(req, res) {
    try {
      const message = await _Text2.default.findAll({ attributes: ['textcontent'],  order: [['id', 'DESC'], ['textcontent', 'DESC'], ['useremail', 'DESC']] }); // O attributes lista somente os campos cujos nomes foram passados no array. Por segurança
