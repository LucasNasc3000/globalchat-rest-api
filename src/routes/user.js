...
router.post('/', loginRequired, userController.store); // Cria o usuário
...
router.put('/:useremail', userController.userBan); // Bane um usuário (tira o acesso à página mas não deleta a conta)
