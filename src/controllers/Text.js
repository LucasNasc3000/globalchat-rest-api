...
class TextController {
  ...
  async index(req, res) {
    try {
      const message = await Text.findAll({ attributes: ['textcontent', 'useremail', 'created_at', 'id', 'msghour'], order: ['id'] }); // O attributes lista somente os campos cujos nomes foram passados no array. Por segurança
